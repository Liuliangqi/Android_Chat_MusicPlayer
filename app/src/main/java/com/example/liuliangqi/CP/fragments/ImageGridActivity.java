...
import com.example.liuliangqi.CP.adapter.ImageGridAdapter;
    ...
    private void initView() {
        ...
        mFinishTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MessageAdapter messageAdapter = ChatFragment.getMessageAdapter();
            ...
            public void onClick(View v) {
                ...
                if (mSelectedMap != null && mSelectedMap.size() > 0) {
                    ...
                    Toast.makeText(ImageGridActivity.this,
                            getString(R.string.need_choose_images), Toast.LENGTH_SHORT).show();
